...
//Sub-categorias
rutas.get("/productos/subcategorias", (req, res) => {
  let query =
    "SELECT SC.id_categoria, SC.nombre, C.nombre FROM sub_categoria SC INNER JOIN categoria C ON SC.id_categoria = C.id_categoria";
